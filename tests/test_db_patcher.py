...
from ..shared import db_patcher


def test_apply_mesh_materials_and_part_attributes() -> None:
    ...
    db_patcher.apply_mesh_materials(cur, material_info)
    ...
    db_patcher.apply_part_attributes(cur, part_attrs)
